...
public class ProductTestwithWebsite extends BaseClass
{
	@Test(groups= {"Smoke","Regression"})
      public void testCreateProduct()
      {
		...
		String websiteName = fl.getExceldata("Product", 1, 3);
		...
		/* navigate to Product page*/
    	 ...
    	 ProductInfoPage pip = cnp.createnewProductwithWebsite(productName, salesStartDate, salesEndDate,websiteName);
